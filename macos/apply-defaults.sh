...
# Current machine uses tap-to-click, secondary click, three-finger drag, smart
# zoom, app expose, Mission Control gestures, natural scrolling, and force click
# disabled.
...
echo "Done. Some keyboard, trackpad, and privacy-protected settings may require logout or reboot."
